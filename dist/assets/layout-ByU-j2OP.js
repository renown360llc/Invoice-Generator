import{g as m,c as $}from"./auth-De7W24vl.js";import{e as B}from"./utils-C_5o-oWL.js";import{s as g}from"./config-c-jMUxvT.js";const A=3,x={viewer:"Viewer",ops:"Operations",finance:"Finance",admin:"Admin"};function l(a,e=""){return String(a??"").trim()||e}function L(a){const e=Number.parseInt(String(a??"").trim(),10);return Number.isFinite(e)&&e>=0?e:A}function S(a){const e=String(a||"").trim().toLowerCase();return x[e]?e:"viewer"}function E(a){return x[S(a)]}function T(a,e=null){var p;const t=(a==null?void 0:a.user_metadata)||{},s=S((e==null?void 0:e.role)||t.role||"viewer"),n=l(t.role_display,l(t.job_title,"")),o=l(t.display_name,l(t.full_name,l((p=a==null?void 0:a.email)==null?void 0:p.split("@")[0],"User"))),v=l(t.workspace_name,l(t.company_name,"")),_=l(t.phone_number,"");return{displayName:o,accessRole:s,roleLabel:e?E(s):n||E(s),workspaceName:v,phoneNumber:_,approvalBufferDays:L((e==null?void 0:e.approval_buffer_days)??t.approval_buffer_days),email:(a==null?void 0:a.email)||"",hasProfilesTable:!!e}}function I(a={}){const e=a.code||"",t=String(a.message||"").toLowerCase();return e==="42P01"||e==="PGRST205"||t.includes("does not exist")}function h(a,e=""){return String(a??"").trim()||e}async function P(a=null){const e=a||await m();if(!e)return null;const{data:t,error:s}=await g.from("profiles").select("*").eq("user_id",e.id).maybeSingle();if(s){if(I(s))return null;throw s}return t||null}async function H(a=null){const e=a||await m();if(!e)return null;const t=await P(e).catch(()=>null);return T(e,t)}async function F(a,e=null){const t=e||await m();if(!t)throw new Error("Not authenticated");const s={display_name:h(a.displayName),full_name:h(a.displayName),workspace_name:h(a.workspaceName),company_name:h(a.workspaceName),phone_number:h(a.phoneNumber)},{error:n}=await g.auth.updateUser({data:s});if(n)throw n;try{await g.from("profiles").upsert({user_id:t.id,approval_buffer_days:L(a.approvalBufferDays)},{onConflict:"user_id"})}catch(o){if(!I(o))throw o}return H(t)}function z(a){return String(a).replace(/[^a-zA-Z0-9 ]+/g," ").split(/\s+/).filter(Boolean).map(e=>e[0]).join("").toUpperCase().slice(0,2)||"?"}async function R(a=""){var M;const e=await m(),t=e?await H(e).catch(()=>null):null,s=(t==null?void 0:t.displayName)||((M=e==null?void 0:e.email)==null?void 0:M.split("@")[0])||"User",n=(t==null?void 0:t.roleLabel)||"Member",o=B(s),v=B(n),_=z(s),p=`
    <div class="app-shell">
        <!-- Mobile Toggle -->
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar__nav">
                ...
                <a href="referrals.html" class="sidebar__link ${a==="referrals"?"sidebar__link--active":""}">
                    <svg class="sidebar__icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="top-header__actions">
                    ...
                    <div class="top-header__user" id="userMenuBtn">
                        ...
                        <div class="top-header__user-info">
                            <span class="top-header__user-name">${o}</span>
    ...
    `;document.body.insertAdjacentHTML("afterbegin",p);const k=document.querySelector(".app-shell__content"),j=document.querySelector(".app-shell"),w=Array.from(document.body.children).filter(r=>r!==j);if(k&&w.length){const r=document.createDocumentFragment();w.forEach(i=>r.appendChild(i)),k.appendChild(r)}N(a);const y=document.getElementById("sidebarToggle"),d=document.getElementById("sidebar"),c=document.getElementById("sidebarOverlay");if(y&&d&&c&&(y.addEventListener("click",()=>{d.classList.toggle("is-open"),c.classList.toggle("is-open")}),c.addEventListener("click",()=>{d.classList.remove("is-open"),c.classList.remove("is-open")})),e){const r=document.getElementById("userMenuBtn"),i=document.getElementById("userMenu");r&&i&&(r.addEventListener("click",f=>{f.stopPropagation(),i.classList.toggle("show")}),document.addEventListener("click",()=>{i.classList.remove("show")}));const u=document.getElementById("logoutBtn"),b=document.getElementById("sidebarLogout"),C=async f=>{f.preventDefault(),await $()};u==null||u.addEventListener("click",C),b==null||b.addEventListener("click",C)}document.addEventListener("layout:toggle-nav",()=>{d==null||d.classList.toggle("is-open"),c==null||c.classList.toggle("is-open")}),document.querySelectorAll('.sidebar__nav a[href$=".html"]').forEach(r=>{const i=r.getAttribute("href");if(!i)return;const u=()=>D(i);r.addEventListener("mouseenter",u,{once:!0,passive:!0}),r.addEventListener("focus",u,{once:!0,passive:!0})})}function D(a){try{const e=new URL(a,window.location.href);if(e.origin!==window.location.origin||!e.pathname.endsWith(".html"))return;const t=`link[rel="prefetch"][href="${e.pathname}"]`;if(document.head.querySelector(t))return;const s=document.createElement("link");s.rel="prefetch",s.as="document",s.href=e.pathname,document.head.appendChild(s)}catch{}}function N(a){const e=document.querySelector(".top-header__search-input");if(!(e instanceof HTMLInputElement))return;const s={consultants:"#searchInput",timesheets:"#searchInput",analytics:"#consultantSearch",invoices:"#searchInput"}[a],n=s?document.querySelector(s):null;if(n instanceof HTMLInputElement){const o=()=>{e.value!==n.value&&(e.value=n.value)};e.placeholder=n.getAttribute("placeholder")||"Search...",o(),n.addEventListener("input",o,{passive:!0}),e.addEventListener("input",()=>{n.value!==e.value&&(n.value=e.value,n.dispatchEvent(new Event("input",{bubbles:!0})))});return}if(a==="dashboard"){e.placeholder="Search recent invoices...",e.addEventListener("input",()=>{document.dispatchEvent(new CustomEvent("dashboard:global-search",{detail:{query:e.value||""}}))});return}e.value="",e.placeholder="Search is not available on this page",e.disabled=!0}function V(a){return{dashboard:"Dashboard",app:"Create Invoice",invoices:"Invoices",referrals:"Referrals",companies:"Companies",consultants:"Consultants",clients:"Clients",analytics:"Analytics",activity:"Activity Log",timesheets:"Timesheets",profile:"Profile",onboarding:"Onboarding Hub","doc-templates":"Document Templates","":"Welcome"}[a]||"Invoice Pro"}export{A as D,H as g,R as l,F as s};
